...
export const action = async ({ request }: ActionArgs) => {
  ...
  const provider = await service.addProvider({ localities, serviceCentreId, ...data });
...
const Add = () => {
  ...
  return (
    <>
      <Form method="post" validator={validator} id="add-provider">
        <Body>
          <Section heading='New Provider' explanation='Please enter the new provider details.' />
          <Group>
            <Field>
              <Input label="Provider Name" name="name" placeholder="e.g. Processing People" />
            </Field>
            <Field>
